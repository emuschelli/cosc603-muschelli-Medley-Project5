...
public class Main {
	...
	public static void addRecipe() {
	    //Read in recipe name
	    final String name = inputOutput("%nPlease enter the recipe name: %n");
	    
	    //Read in recipe price
	    final String priceString = inputOutput("%nPlease enter the recipe price: $%n");
	    ...
	    //Read in amt coffee
	    final String coffeeString = inputOutput("%nPlease enter the units of coffee in the recipe: %n");
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput("%nPlease enter the units of milk in the recipe: %n");
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput("%nPlease enter the units of sugar in the recipe: %n");
	    ...
	    final String chocolateString = inputOutput("%nPlease enter the units of chocolate in the recipe: %n");
    ...
    public static void addInventory() {
	    //Read in amt coffee
	    final String coffeeString = inputOutput("%nPlease enter the units of coffee to add: %n");
	    final int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput("%nPlease enter the units of milk to add: %n");
	    final int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput("%nPlease enter the units of sugar to add: %n");
	    final int amtSugar = stringToInt(sugarString);
	    if(amtSugar < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt chocolate
	    final String chocolateString = inputOutput("%nPlease enter the units of chocolate to add: %n");
	    final int amtChocolate = stringToInt(chocolateString);
	    if(amtChocolate < 0) {
	    	mainMenu();
	    }
